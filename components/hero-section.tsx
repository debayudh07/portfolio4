      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h1 className="text-[42px] leading-[50px] md:text-[72px] font-bold md:leading-[85px]">
            I'm <span className="bg-[#FF6B7A] text-white px-3 py-1 inline-block">Debayudh Basu</span>, a Full-Stack & Web3 Developer from{" "}
            <span className="bg-[#2F81F7] text-white px-3 py-1 inline-block">Kolkata</span>
          </h1>

          <p className="text-[#393939] text-[16px] md:text-[18px] font-medium leading-[28px] md:leading-[30px] max-w-xl">
            Building decentralized protocols, enterprise backends, and AI-powered solutions. Specialized in blockchain architecture, full-stack development, and scalable system design.
          </p>
        ...
        <div className="flex justify-center md:justify-end">
          <div className="relative w-full max-w-md aspect-square bg-[#FDB927] border-4 border-black rounded-3xl overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            <img
              src="/dpimage1.jpeg"
              alt="Debayudh Basu - Developer Illustration"
